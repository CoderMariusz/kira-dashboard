/**
 * __tests__/hooks/useNightClawResearch.test.tsx
 * STORY-9.5 — Unit tests for useNightClawResearch hook
 *
 * Test matrix:
...
const MOCK_RESEARCH: ResearchResponse = {
  files: [
    {
      filename: 'ops-007-glm-timeout.md',
      title: 'OPS-007 GLM Timeout Fix',
      preview: 'Root cause: GLM-5 blocked REVIEW stage...',
      content: '# Full solution content here',
      modified_at: '2026-02-25T04:30:00Z',
    },
  ],
}

describe('useNightClawResearch', () => {
  beforeEach(() => {
    mockFetch.mockClear()
  })
  ...
  it('TC-1: isLoading=true initially', () => {
    ...
    const { result } = renderHook(() => useNightClawResearch(), {
  ...
  it('TC-2: returns data on success', async () => {
    ...
    expect(result.current.data).toEqual(MOCK_RESEARCH)
